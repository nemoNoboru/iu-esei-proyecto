...
--
-- Host: localhost
-- Generation Time: Nov 04, 2015 at 06:43 PM
...
(4, 'Otra Funcionalidad', ' jvhiffu'),
(5, 'Funcionalidad Extra', 'Esta funcionalaidad es extra'),
(6, 'Funcion', 'Con Descripcion');
...
(4, 'UNA PAGINA', 'UNA DESCRIPCION o dos'),
(6, 'Pagina2', 'Descripcion pagina 2'),
(7, 'Pagina3', 'DescripciÃ³n pagina 3');
...
(4, 'Rol ejemplo', 'Esto es un ejemplito de rol');
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='tabla de usuarios';
...
(1, 'userDummy1', 'pass', 'usuario de test unit o novevs', 'dummy@dummy'),
(2, 'userDummy2', '12345', 'usuario de test unit', 'dummy@dummy'),
(4, 'Test1', 'testo', 'destalles test1', 'tes@test.t'),
(5, 'Odaveng', '1234', 'Es un puto y perdio la promo', 'Q');
